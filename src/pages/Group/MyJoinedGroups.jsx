        ...
        <WithGroupHomeSidebar>
            <div className="group-content">
                <div className="mb-4 flex items-center justify-between">
                    <h2 className="color_h1 text-base font-medium">All groups you've joined
                        ({state?.groups?.length})</h2>
                    <Button>Sort</Button>
                </div>
                        ...
                        state.groups.map(group => (
                            <div key={group._id} className="group-card card relative !p-3">
                                ...
                                <div className="flex items-center gap-x-2">
                                    <div className="w-16 h-16 overflow-hidden">
                                        <img className="aspect-square rounded-md object-cover"
                                             src={staticImage(group.coverPhoto)} alt=""/>
                                    </div>
                                ...
                                <div className="flex items-center gap-x-2 mt-4">
                                    <Link to={`/groups/${group.slug}`} className="w-full">
