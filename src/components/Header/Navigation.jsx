...
const Navigation = (props) => {
    ...
    function checkActiveNav(pathname) {
        let setItem = "";
        if (pathname.indexOf("/watch/reels") !== -1) {
            setItem = "reels"
        } else if (pathname.indexOf("/watch") !== -1) {
            setItem = "watch"
    ...
    let navItems = [
        {
            ...
            icon: <svg viewBox="0 0 28 28"
                       className="text-body-dark dark:text-body-light a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh"
                       fill="currentColor"
                       height="28" width="28">
                <path
            ...
            icon2: <svg viewBox="0 0 28 28"
                        className="text-body-dark dark:text-body-light a8c37x1j ms05siws l3qrxjdp b7h9ocf4 g28tu32o"
                        fill="currentColor"
                        height="28" width="28">
                <path
        ...
        },
        {
            ...
            iicon2: <svg viewBox="0 0 28 28" className="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 g28tu32o"
                         fill="currentColor"
                         height="28" width="28">
                <path
                    d="M25.825 12.29C25.824 12.289 25.823 12.288 25.821 12.286L15.027 2.937C14.752 2.675 14.392 2.527 13.989 2.521 13.608 2.527 13.248 2.675 13.001 2.912L2.175 12.29C1.756 12.658 1.629 13.245 1.868 13.759 2.079 14.215 2.567 14.479 3.069 14.479L5 14.479 5 23.729C5 24.695 5.784 25.479 6.75 25.479L11 25.479C11.552 25.479 12 25.031 12 24.479L12 18.309C12 18.126 12.148 17.979 12.33 17.979L15.67 17.979C15.852 17.979 16 18.126 16 18.309L16 24.479C16 25.031 16.448 25.479 17 25.479L21.25 25.479C22.217 25.479 23 24.695 23 23.729L23 14.479 24.931 14.479C25.433 14.479 25.921 14.215 26.132 13.759 26.371 13.245 26.244 12.658 25.825 12.29"></path>
        ...
        {
            id: "reels",
            icon: <img src="/icons/reels.png" className="png_filter_white w-[22px]"/>,
            // icon: <svg viewBox="0 0 28 28"
            //            className="text-body-dark dark:text-body-light a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh"
            //            fill="currentColor"
            //            height="28" width="28">
                ...
                <div className="w-full mx-auto px-0 sm:px-2">
                    <ul className="main-nav ">
                        ...
                        <div className="nav-center">
                            <ul className="nav_items flex  items-center">
                                {navItems.map((item, index,) => (
                                    <div key={index}
                                         className={["flex justify-center", activeNav === item.id ? "border-b-[3px] border-primary" : "hover:bg-dark-50/30 rounded-lg "].join(" ")}>
                                        <li className="nav_item py-3 ">
                                            <NavLink onClick={() => handleSwitchRoute(item.to)} className=""
                                                     to={item.to}>
                                                <span
                                                    className={["", activeNav === item.id ? "active_nav" : ""].join(" ")}>{item.icon}</span>
                                            </NavLink>
                                        </li>
                                    </div>
                                ))}
                        ...
                        <div className="nav-auth">
                            ...
                            <ul className="nav_items flex justify-end items-center relative">

                                {/******** user item ********/}
                                <li className="flex items-center relative py-3"
                                  ...
                                  <span className="">
                                    ...
                                    <CSSTransition
                                        unmountOnExit
                                        classNames="dropdown-top-right-animation"
                                        in={expandDropdown === "authMenu" && auth && auth._id}
                                        timeout={200}>
                                            <MoreDropdown
                                                onSetExpandDropdown={setExpandDropdown}
                                            />
                                    </CSSTransition>
                                ...
                                {/******** messenger item ********/}
                                <li className="ml-3">
                                    <div onClick={() => handleExpandDropdown("messenger")}
                                         className={["rounded_circle", expandDropdown === "messenger" ? "text-primary" : "text-body-dark dark:text-body-light"].join(" ")}>
                                ...
                                <li className="ml-3 relative">
                                    <div onClick={() => handleExpandDropdown("notification")}
                                         className={["rounded_circle", expandDropdown === "notification" ? "text-primary" : "text-body-dark dark:text-body-light"].join(" ")}>
                                        <svg viewBox="0 0 28 28"
                                             className="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 rs22bh7c"
                                             fill="currentColor" height="20" width="20">
                                            <path
                                    ...
                                    <Badge count={unreadNotificationCount(notifications)}/>
                                </li>

                                <CSSTransition unmountOnExit classNames="dropdown-top-right-animation"
                                               in={expandDropdown === "notification"} timeout={200}>
                                    <NotificationDropdown onClose={() => setExpandDropdown("")}/>
                                </CSSTransition>


                                {/******** more options item ********/}
                                {/*   <li className="hidden md:block ml-2">*/}
                                {/*       <div className="rounded_circle text-white"*/}
                                {/*            onClick={() => handleExpandDropdown("more")}>*/}
                                {/*           <div className="w-3.5">*/}
                                {/*               <svg*/}
                                {/*                   className={[expandDropdown === "more" ? "fill-primary" : "fill-body-dark dark:fill-body-light"].join(" ")}*/}
                                {/*                   viewBox="0 0 159 96" xmlns="http://www.w3.org/2000/svg">*/}
                                {/*                   <path d="M154.963 23.4013L89.1815 91.3692C86.4986 94.0522 83.0207 95.3936 79.4931 95.3936C75.9879 95.3936*/}
                                {/*72.4777 94.0512 69.8196 91.3647L4.0377 23.3968C-4.58698 14.8059 1.51623 0 13.741 0H145.255C157.448 0 163.559*/}
                                {/* 14.8059 154.963 23.4013Z"*/}
                                {/*                   />*/}
                                {/*               </svg>*/}
                                {/*           </div>*/}
                                {/*       </div>*/}
