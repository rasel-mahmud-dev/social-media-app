                        ...
                        <div className="nav-center">
                            <ul className="nav_items flex  items-center">
                                {navItems.map((item, index,) => (
                                    <div key={index}
                                         className={["flex justify-center", activeNav === item.to ? "border-b-[3px] border-primary" : "hover:bg-dark-50/30 rounded-lg "].join(" ")}>
                                        <li className="nav_item py-3 ">
                                            <NavLink onClick={() => handleSwitchRoute(item.to)} className=""
                                                     to={item.to}>
                            <span
                                className={["", activeNav === item.to ? "active_nav" : ""].join(" ")}>{item.icon}</span>
                                            </NavLink>
                                        </li>
                                    </div>
                                ))}
